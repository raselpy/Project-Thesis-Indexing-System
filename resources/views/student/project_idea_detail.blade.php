               ...
               <div class="card-body" style="background-color: #f5f5f5">
                        <div class="row">
                            <div class="col-lg-8 col-md-8" style="background-color: white;padding-top: 25px">
                                    <dt><span style="color: #3955F7;font-size: 20px">P</span>roject Idea Detail : </dt>
                                    <p style="text-align: justify;font-family: 'Noto Sans TC', sans-serif;"> {{$ideas->description}}</p>
                            </div>
