...
<div class="container" style="user-select: none;">
       <div >
            <form class="ui form ui tall  segment" method="GET" style="margin-bottom: 30px" action="{{route('thesis_search')}}">
              ...
              <div class="three fields ">
                       ...
                       <input class="field" style="margin-left: 40px;width: 300px" value="{{ isset($name) ? $name : '' }}" name="name" type="text" placeholder="Thesis name">
